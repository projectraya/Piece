        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalFilePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    JamendoTrackId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTrackLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTrackLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTrackLikes_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tracks_JamendoTrackId",
                table: "Tracks",
                column: "JamendoTrackId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTrackLikes_TrackId",
